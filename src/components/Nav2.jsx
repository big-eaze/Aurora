import { FaTimes, FaUserShield, FaUserGraduate, FaUserTie } from "react-icons/fa";
      ...
      <header className="flex flex-col items-center justify-center px-6 py-6 border-b border-white/10">
        ...
        <div className="mt-6 flex flex-col items-center gap-2">
          {subtitle === "Admin Panel" ? (
            ...
            :
            <FaUserTie size={42} className="text-indigo-400 drop-shadow-[0_0_12px_rgba(99,102,241,0.6)]" />
          }
