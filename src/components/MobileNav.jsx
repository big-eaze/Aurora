    ...
    <AnimatePresence mode="wait">
      {displayMenu && (
        <>
          ...
          >
            <header className="flex-shrink-0 flex flex-col items-center justify-center px-6 py-6 border-b border-white/10">
            ...
            {/* Nav (scrollable area) */}
            <nav className="flex-1 px-4 py-8 space-y-3 overflow-y-auto scrollbar-thin scrollbar-thumb-slate-700 scrollbar-track-transparent">
